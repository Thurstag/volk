...
namespace Volk.Vulkan {
    public static class Commands {
        public delegate Result AcquireFullScreenExclusiveModeEXT(Device device, SwapchainKHR swapchain);

        public delegate Result AcquireImageANDROID(Device device, Image image, short nativeFenceFd, Semaphore semaphore, Fence fence);
        ...
        public delegate Result BindBufferMemory(Device device, Buffer buffer, DeviceMemory memory, ulong memoryOffset);

        public unsafe delegate Result BindBufferMemory2(Device device, uint bindInfoCount, BindBufferMemoryInfo* bindInfos);

        public delegate Result BindImageMemory(Device device, Image image, DeviceMemory memory, ulong memoryOffset);
        ...
        public delegate void CmdBeginQuery(CommandBuffer commandBuffer, QueryPool queryPool, uint query, QueryControlFlags flags);

        public delegate void CmdBeginQueryIndexedEXT(CommandBuffer commandBuffer, QueryPool queryPool, uint query, QueryControlFlags flags,
                                                     uint index);
        ...
        public unsafe delegate void CmdBeginTransformFeedbackEXT(CommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount,
                                                                 Buffer* counterBuffers, ulong* counterBufferOffsets);
        ...
        public delegate void CmdBindIndexBuffer(CommandBuffer commandBuffer, Buffer buffer, ulong offset, IndexType indexType);

        public delegate void CmdBindPipeline(CommandBuffer commandBuffer, PipelineBindPoint pipelineBindPoint, Pipeline pipeline);

        public delegate void CmdBindPipelineShaderGroupNV(CommandBuffer commandBuffer, PipelineBindPoint pipelineBindPoint, Pipeline pipeline,
                                                          uint groupIndex);

        public delegate void CmdBindShadingRateImageNV(CommandBuffer commandBuffer, ImageView imageView, ImageLayout imageLayout);
        ...
        public unsafe delegate void CmdBindTransformFeedbackBuffersEXT(CommandBuffer commandBuffer, uint firstBinding, uint bindingCount,
                                                                       Buffer* buffers, ulong* offsets, ulong* sizes);
        ...
        public unsafe delegate void CmdBindVertexBuffers2EXT(CommandBuffer commandBuffer, uint firstBinding, uint bindingCount, Buffer* buffers,
                                                             ulong* offsets, ulong* sizes, ulong* strides);
        ...
        public unsafe delegate void CmdBuildAccelerationStructureIndirectKHR(CommandBuffer commandBuffer,
                                                                             ...
                                                                             ulong indirectOffset, uint indirectStride);
        ...
        public unsafe delegate void CmdBuildAccelerationStructureNV(CommandBuffer commandBuffer, AccelerationStructureInfoNV* info,
                                                                    Buffer instanceData, ulong instanceOffset, uint update,
        ...
        public delegate void CmdCopyAccelerationStructureNV(CommandBuffer commandBuffer, AccelerationStructureKHR dst,
        ...
        public delegate void CmdCopyQueryPoolResults(CommandBuffer commandBuffer, QueryPool queryPool, uint firstQuery, uint queryCount,
                                                     Buffer dstBuffer, ulong dstOffset, ulong stride, QueryResultFlags flags);

        public unsafe delegate void CmdDebugMarkerBeginEXT(CommandBuffer commandBuffer, DebugMarkerMarkerInfoEXT* markerInfo);

        public delegate void CmdDebugMarkerEndEXT(CommandBuffer commandBuffer);

        public unsafe delegate void CmdDebugMarkerInsertEXT(CommandBuffer commandBuffer, DebugMarkerMarkerInfoEXT* markerInfo);

        public delegate void CmdDispatch(CommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);

        public delegate void CmdDispatchBase(CommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX,
                                             uint groupCountY, uint groupCountZ);

        public delegate void CmdDispatchIndirect(CommandBuffer commandBuffer, Buffer buffer, ulong offset);

        public delegate void CmdDraw(CommandBuffer commandBuffer, uint vertexCount, uint instanceCount, uint firstVertex, uint firstInstance);

        public delegate void CmdDrawIndexed(CommandBuffer commandBuffer, uint indexCount, uint instanceCount, uint firstIndex,
                                            int vertexOffset, uint firstInstance);

        public delegate void CmdDrawIndexedIndirect(CommandBuffer commandBuffer, Buffer buffer, ulong offset, uint drawCount,
                                                    uint stride);

        public delegate void CmdDrawIndexedIndirectCount(CommandBuffer commandBuffer, Buffer buffer, ulong offset, Buffer countBuffer,
                                                         ulong countBufferOffset, uint maxDrawCount, uint stride);

        public delegate void CmdDrawIndirect(CommandBuffer commandBuffer, Buffer buffer, ulong offset, uint drawCount, uint stride);

        public delegate void CmdDrawIndirectByteCountEXT(CommandBuffer commandBuffer, uint instanceCount, uint firstInstance,
                                                         Buffer counterBuffer, ulong counterBufferOffset, uint counterOffset,
                                                         uint vertexStride);

        public delegate void CmdDrawIndirectCount(CommandBuffer commandBuffer, Buffer buffer, ulong offset, Buffer countBuffer,
                                                  ulong countBufferOffset, uint maxDrawCount, uint stride);

        public delegate void CmdDrawMeshTasksIndirectCountNV(CommandBuffer commandBuffer, Buffer buffer, ulong offset, Buffer countBuffer,
                                                             ulong countBufferOffset, uint maxDrawCount, uint stride);

        public delegate void CmdDrawMeshTasksIndirectNV(CommandBuffer commandBuffer, Buffer buffer, ulong offset, uint drawCount,
                                                        uint stride);

        public delegate void CmdDrawMeshTasksNV(CommandBuffer commandBuffer, uint taskCount, uint firstTask);

        public delegate void CmdEndConditionalRenderingEXT(CommandBuffer commandBuffer);

        public delegate void CmdEndDebugUtilsLabelEXT(CommandBuffer commandBuffer);

        public delegate void CmdEndQuery(CommandBuffer commandBuffer, QueryPool queryPool, uint query);

        public delegate void CmdEndQueryIndexedEXT(CommandBuffer commandBuffer, QueryPool queryPool, uint query, uint index);

        public delegate void CmdEndRenderPass(CommandBuffer commandBuffer);
        ...
        public unsafe delegate void CmdExecuteGeneratedCommandsNV(CommandBuffer commandBuffer, uint isPreprocessed,
                                                                  GeneratedCommandsInfoNV* generatedCommandsInfo);

        public delegate void CmdFillBuffer(CommandBuffer commandBuffer, Buffer dstBuffer, ulong dstOffset, ulong size, uint data);

        public unsafe delegate void CmdInsertDebugUtilsLabelEXT(CommandBuffer commandBuffer, DebugUtilsLabelEXT* labelInfo);

        public delegate void CmdNextSubpass(CommandBuffer commandBuffer, SubpassContents contents);
        ...
        public delegate void CmdResetEvent(CommandBuffer commandBuffer, Event @event, PipelineStageFlags stageMask);

        public delegate void CmdResetQueryPool(CommandBuffer commandBuffer, QueryPool queryPool, uint firstQuery, uint queryCount);
        ...
        public delegate void CmdSetBlendConstants(CommandBuffer commandBuffer, float[] blendConstants);
        ...
        public delegate void CmdSetCullModeEXT(CommandBuffer commandBuffer, CullModeFlags cullMode);

        public delegate void CmdSetDepthBias(CommandBuffer commandBuffer, float depthBiasConstantFactor, float depthBiasClamp,
                                             float depthBiasSlopeFactor);

        public delegate void CmdSetDepthBounds(CommandBuffer commandBuffer, float minDepthBounds, float maxDepthBounds);

        public delegate void CmdSetDepthBoundsTestEnableEXT(CommandBuffer commandBuffer, uint depthBoundsTestEnable);

        public delegate void CmdSetDepthCompareOpEXT(CommandBuffer commandBuffer, CompareOp depthCompareOp);

        public delegate void CmdSetDepthTestEnableEXT(CommandBuffer commandBuffer, uint depthTestEnable);

        public delegate void CmdSetDepthWriteEnableEXT(CommandBuffer commandBuffer, uint depthWriteEnable);

        public delegate void CmdSetDeviceMask(CommandBuffer commandBuffer, uint deviceMask);
        ...
        public delegate void CmdSetEvent(CommandBuffer commandBuffer, Event @event, PipelineStageFlags stageMask);
        ...
        public delegate void CmdSetFrontFaceEXT(CommandBuffer commandBuffer, FrontFace frontFace);

        public delegate void CmdSetLineStippleEXT(CommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern);

        public delegate void CmdSetLineWidth(CommandBuffer commandBuffer, float lineWidth);
        ...
        public delegate void CmdSetPrimitiveTopologyEXT(CommandBuffer commandBuffer, PrimitiveTopology primitiveTopology);
        ...
        public delegate void CmdSetStencilCompareMask(CommandBuffer commandBuffer, StencilFaceFlags faceMask, uint compareMask);

        public delegate void CmdSetStencilOpEXT(CommandBuffer commandBuffer, StencilFaceFlags faceMask, StencilOp failOp, StencilOp passOp,
                                                StencilOp depthFailOp, CompareOp compareOp);

        public delegate void CmdSetStencilReference(CommandBuffer commandBuffer, StencilFaceFlags faceMask, uint reference);

        public delegate void CmdSetStencilTestEnableEXT(CommandBuffer commandBuffer, uint stencilTestEnable);

        public delegate void CmdSetStencilWriteMask(CommandBuffer commandBuffer, StencilFaceFlags faceMask, uint writeMask);
        ...
        public unsafe delegate void CmdTraceRaysIndirectKHR(CommandBuffer commandBuffer, StridedBufferRegionKHR* raygenShaderBindingTable,
                                                            ...
                                                            StridedBufferRegionKHR* callableShaderBindingTable, Buffer buffer, ulong offset);
        ...
        public delegate void CmdTraceRaysNV(CommandBuffer commandBuffer, Buffer raygenShaderBindingTableBuffer,
                                            ulong raygenShaderBindingOffset, Buffer missShaderBindingTableBuffer,
                                            ulong missShaderBindingOffset, ulong missShaderBindingStride,
                                            Buffer hitShaderBindingTableBuffer, ulong hitShaderBindingOffset,
                                            ulong hitShaderBindingStride, Buffer callableShaderBindingTableBuffer,
                                            ulong callableShaderBindingOffset, ulong callableShaderBindingStride, uint width,
                                            uint height, uint depth);

        public unsafe delegate void CmdUpdateBuffer(CommandBuffer commandBuffer, Buffer dstBuffer, ulong dstOffset, ulong dataSize,
                                                    void* data);
        ...
        public delegate void CmdWriteBufferMarkerAMD(CommandBuffer commandBuffer, PipelineStageFlags pipelineStage, Buffer dstBuffer,
                                                     ulong dstOffset, uint marker);

        public delegate void CmdWriteTimestamp(CommandBuffer commandBuffer, PipelineStageFlags pipelineStage, QueryPool queryPool, uint query);

        public delegate Result CompileDeferredNV(Device device, Pipeline pipeline, uint shader);
        ...
        public delegate Result DeferredOperationJoinKHR(Device device, DeferredOperationKHR operation);
        ...
        public delegate Result DeviceWaitIdle(Device device);
        ...
        public delegate Result EndCommandBuffer(CommandBuffer commandBuffer);
        ...
        public unsafe delegate ulong GetAccelerationStructureDeviceAddressKHR(Device device, AccelerationStructureDeviceAddressInfoKHR* info);
        ...
        public unsafe delegate ulong GetBufferDeviceAddress(Device device, BufferDeviceAddressInfo* info);
        ...
        public delegate uint GetDeferredOperationMaxConcurrencyKHR(Device device, DeferredOperationKHR operation);

        public delegate Result GetDeferredOperationResultKHR(Device device, DeferredOperationKHR operation);
        ...
        public unsafe delegate void GetDeviceMemoryCommitment(Device device, DeviceMemory memory, ulong* committedMemoryInBytes);
        ...
        public delegate Result GetEventStatus(Device device, Event @event);

        public unsafe delegate Result GetFenceFdKHR(Device device, FenceGetFdInfoKHR* getFdInfo, short* fd);

        public delegate Result GetFenceStatus(Device device, Fence fence);
        ...
        public unsafe delegate uint GetPhysicalDeviceDirectFBPresentationSupportEXT(PhysicalDevice physicalDevice, uint queueFamilyIndex,
                                                                                    void** dfb);
        ...
        public unsafe delegate uint GetPhysicalDeviceWaylandPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex,
                                                                                   void** display);

        public delegate uint GetPhysicalDeviceWin32PresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex);

        public unsafe delegate uint GetPhysicalDeviceXcbPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex,
                                                                               void** connection, void* visual_id);

        public unsafe delegate uint GetPhysicalDeviceXlibPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, void** dpy,
                                                                                void* visualID);
        ...
        public unsafe delegate Result GetQueryPoolResults(Device device, QueryPool queryPool, uint firstQuery, uint queryCount, nuint dataSize,
                                                          void* data, ulong stride, QueryResultFlags flags);
        ...
        public delegate Result GetSwapchainStatusKHR(Device device, SwapchainKHR swapchain);
        ...
        public unsafe delegate Result MapMemory(Device device, DeviceMemory memory, ulong offset, ulong size, MemoryMapFlags flags,
                                                void** data);
        ...
        public delegate void QueueEndDebugUtilsLabelEXT(Queue queue);
        ...
        public delegate Result QueueSetPerformanceConfigurationINTEL(Queue queue, PerformanceConfigurationINTEL configuration);
        ...
        public delegate Result QueueWaitIdle(Queue queue);
        ...
        public delegate Result ReleaseDisplayEXT(PhysicalDevice physicalDevice, DisplayKHR display);

        public delegate Result ReleaseFullScreenExclusiveModeEXT(Device device, SwapchainKHR swapchain);

        public delegate Result ReleasePerformanceConfigurationINTEL(Device device, PerformanceConfigurationINTEL configuration);

        public delegate void ReleaseProfilingLockKHR(Device device);

        public delegate Result ResetCommandBuffer(CommandBuffer commandBuffer, CommandBufferResetFlags flags);

        public delegate Result ResetCommandPool(Device device, CommandPool commandPool, CommandPoolResetFlags flags);

        public delegate Result ResetDescriptorPool(Device device, DescriptorPool descriptorPool, DescriptorPoolResetFlags flags);

        public delegate Result ResetEvent(Device device, Event @event);

        public unsafe delegate Result ResetFences(Device device, uint fenceCount, Fence* fences);

        public delegate void ResetQueryPool(Device device, QueryPool queryPool, uint firstQuery, uint queryCount);
        ...
        public delegate Result SetEvent(Device device, Event @event);
        ...
        public delegate void SetLocalDimmingAMD(Device device, SwapchainKHR swapChain, uint localDimmingEnable);

        public delegate Result SetPrivateDataEXT(Device device, ObjectType objectType, ulong objectHandle, PrivateDataSlotEXT privateDataSlot,
                                                 ulong data);
        ...
        public delegate void TrimCommandPool(Device device, CommandPool commandPool, CommandPoolTrimFlags flags);

        public delegate void UninitializePerformanceApiINTEL(Device device);

        public delegate void UnmapMemory(Device device, DeviceMemory memory);
        ...
        public unsafe delegate Result WaitForFences(Device device, uint fenceCount, Fence* fences, uint waitAll, ulong timeout);
