...
namespace Volk.Vulkan {
	public static class Commands {
		...
		public unsafe delegate void GetPhysicalDeviceQueueFamilyProperties(PhysicalDevice physicalDevice, uint* queueFamilyPropertyCount, QueueFamilyProperties* queueFamilyProperties);

		public unsafe delegate void GetPhysicalDeviceMemoryProperties(PhysicalDevice physicalDevice, PhysicalDeviceMemoryProperties* memoryProperties);
		...
		public unsafe delegate Result GetPhysicalDeviceImageFormatProperties(PhysicalDevice physicalDevice, Format format, ImageType type, ImageTiling tiling, ImageUsageFlags usage, ImageCreateFlags flags, ImageFormatProperties* imageFormatProperties);

		public unsafe delegate Result CreateDevice(PhysicalDevice physicalDevice, DeviceCreateInfo* createInfo, AllocationCallbacks* allocator, Device* device);
		...
		public unsafe delegate Result EnumerateDeviceExtensionProperties(PhysicalDevice physicalDevice, byte* layerName, uint* propertyCount, ExtensionProperties* properties);
		...
		public unsafe delegate Result AllocateMemory(Device device, MemoryAllocateInfo* allocateInfo, AllocationCallbacks* allocator, DeviceMemory* memory);
		...
		public unsafe delegate void GetImageSparseMemoryRequirements(Device device, Image image, uint* sparseMemoryRequirementCount, SparseImageMemoryRequirements* sparseMemoryRequirements);
		...
		public unsafe delegate Result CreateSemaphore(Device device, SemaphoreCreateInfo* createInfo, AllocationCallbacks* allocator, Semaphore* semaphore);
		...
		public unsafe delegate Result CreateQueryPool(Device device, QueryPoolCreateInfo* createInfo, AllocationCallbacks* allocator, QueryPool* queryPool);

		public unsafe delegate void DestroyQueryPool(Device device, QueryPool queryPool, AllocationCallbacks* allocator);

		public unsafe delegate Result GetQueryPoolResults(Device device, QueryPool queryPool, uint firstQuery, uint queryCount, nuint dataSize, void* data, DeviceSize stride, QueryResultFlags flags);
		...
		public unsafe delegate Result CreateBufferView(Device device, BufferViewCreateInfo* createInfo, AllocationCallbacks* allocator, BufferView* view);
		...
		public unsafe delegate Result CreateImageView(Device device, ImageViewCreateInfo* createInfo, AllocationCallbacks* allocator, ImageView* view);

		public unsafe delegate void DestroyImageView(Device device, ImageView imageView, AllocationCallbacks* allocator);

		public unsafe delegate Result CreateShaderModule(Device device, ShaderModuleCreateInfo* createInfo, AllocationCallbacks* allocator, ShaderModule* shaderModule);

		public unsafe delegate void DestroyShaderModule(Device device, ShaderModule shaderModule, AllocationCallbacks* allocator);

		public unsafe delegate Result CreatePipelineCache(Device device, PipelineCacheCreateInfo* createInfo, AllocationCallbacks* allocator, PipelineCache* pipelineCache);
		...
		public unsafe delegate Result CreateGraphicsPipelines(Device device, PipelineCache pipelineCache, uint createInfoCount, GraphicsPipelineCreateInfo* createInfos, AllocationCallbacks* allocator, Pipeline* pipelines);

		public unsafe delegate Result CreateComputePipelines(Device device, PipelineCache pipelineCache, uint createInfoCount, ComputePipelineCreateInfo* createInfos, AllocationCallbacks* allocator, Pipeline* pipelines);

		public unsafe delegate void DestroyPipeline(Device device, Pipeline pipeline, AllocationCallbacks* allocator);

		public unsafe delegate Result CreatePipelineLayout(Device device, PipelineLayoutCreateInfo* createInfo, AllocationCallbacks* allocator, PipelineLayout* pipelineLayout);
		...
		public unsafe delegate Result CreateDescriptorSetLayout(Device device, DescriptorSetLayoutCreateInfo* createInfo, AllocationCallbacks* allocator, DescriptorSetLayout* setLayout);

		public unsafe delegate void DestroyDescriptorSetLayout(Device device, DescriptorSetLayout descriptorSetLayout, AllocationCallbacks* allocator);

		public unsafe delegate Result CreateDescriptorPool(Device device, DescriptorPoolCreateInfo* createInfo, AllocationCallbacks* allocator, DescriptorPool* descriptorPool);
		...
		public unsafe delegate Result CreateFramebuffer(Device device, FramebufferCreateInfo* createInfo, AllocationCallbacks* allocator, Framebuffer* framebuffer);

		public unsafe delegate void DestroyFramebuffer(Device device, Framebuffer framebuffer, AllocationCallbacks* allocator);

		public unsafe delegate Result CreateRenderPass(Device device, RenderPassCreateInfo* createInfo, AllocationCallbacks* allocator, RenderPass* renderPass);
		...
		public unsafe delegate Result CreateCommandPool(Device device, CommandPoolCreateInfo* createInfo, AllocationCallbacks* allocator, CommandPool* commandPool);
		...
		public unsafe delegate void CmdSetDepthBias(CommandBuffer commandBuffer, float depthBiasConstantFactor, float depthBiasClamp, float depthBiasSlopeFactor);
		...
		public unsafe delegate void CmdClearColorImage(CommandBuffer commandBuffer, Image image, ImageLayout imageLayout, ClearColorValue* color, uint rangeCount, ImageSubresourceRange* ranges);

		public unsafe delegate void CmdClearDepthStencilImage(CommandBuffer commandBuffer, Image image, ImageLayout imageLayout, ClearDepthStencilValue* depthStencil, uint rangeCount, ImageSubresourceRange* ranges);
		...
		public unsafe delegate void CmdBeginConditionalRenderingEXT(CommandBuffer commandBuffer, ConditionalRenderingBeginInfoEXT* conditionalRenderingBegin);
		...
		public unsafe delegate Result CreateAndroidSurfaceKHR(Instance instance, AndroidSurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result GetPhysicalDeviceDisplayPropertiesKHR(PhysicalDevice physicalDevice, uint* propertyCount, DisplayPropertiesKHR* properties);

		public unsafe delegate Result GetPhysicalDeviceDisplayPlanePropertiesKHR(PhysicalDevice physicalDevice, uint* propertyCount, DisplayPlanePropertiesKHR* properties);

		public unsafe delegate Result GetDisplayPlaneSupportedDisplaysKHR(PhysicalDevice physicalDevice, uint planeIndex, uint* displayCount, DisplayKHR* displays);

		public unsafe delegate Result GetDisplayModePropertiesKHR(PhysicalDevice physicalDevice, DisplayKHR display, uint* propertyCount, DisplayModePropertiesKHR* properties);

		public unsafe delegate Result CreateDisplayModeKHR(PhysicalDevice physicalDevice, DisplayKHR display, DisplayModeCreateInfoKHR* createInfo, AllocationCallbacks* allocator, DisplayModeKHR* mode);

		public unsafe delegate Result GetDisplayPlaneCapabilitiesKHR(PhysicalDevice physicalDevice, DisplayModeKHR mode, uint planeIndex, DisplayPlaneCapabilitiesKHR* capabilities);

		public unsafe delegate Result CreateDisplayPlaneSurfaceKHR(Instance instance, DisplaySurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateSharedSwapchainsKHR(Device device, uint swapchainCount, SwapchainCreateInfoKHR* createInfos, AllocationCallbacks* allocator, SwapchainKHR* swapchains);

		public unsafe delegate void DestroySurfaceKHR(Instance instance, SurfaceKHR surface, AllocationCallbacks* allocator);

		public unsafe delegate Result GetPhysicalDeviceSurfaceSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, SurfaceKHR surface, Bool32* supported);

		public unsafe delegate Result GetPhysicalDeviceSurfaceCapabilitiesKHR(PhysicalDevice physicalDevice, SurfaceKHR surface, SurfaceCapabilitiesKHR* surfaceCapabilities);

		public unsafe delegate Result GetPhysicalDeviceSurfaceFormatsKHR(PhysicalDevice physicalDevice, SurfaceKHR surface, uint* surfaceFormatCount, SurfaceFormatKHR* surfaceFormats);

		public unsafe delegate Result GetPhysicalDeviceSurfacePresentModesKHR(PhysicalDevice physicalDevice, SurfaceKHR surface, uint* presentModeCount, PresentModeKHR* presentModes);

		public unsafe delegate Result CreateSwapchainKHR(Device device, SwapchainCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SwapchainKHR* swapchain);
		...
		public unsafe delegate Result AcquireNextImageKHR(Device device, SwapchainKHR swapchain, ulong timeout, Semaphore semaphore, Fence fence, uint* imageIndex);

		public unsafe delegate Result QueuePresentKHR(Queue queue, PresentInfoKHR* presentInfo);

		public unsafe delegate Result CreateViSurfaceNN(Instance instance, ViSurfaceCreateInfoNN* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateWaylandSurfaceKHR(Instance instance, WaylandSurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Bool32 GetPhysicalDeviceWaylandPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, void** display);

		public unsafe delegate Result CreateWin32SurfaceKHR(Instance instance, Win32SurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);
		...
		public unsafe delegate Result CreateXlibSurfaceKHR(Instance instance, XlibSurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Bool32 GetPhysicalDeviceXlibPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, void** dpy, void* visualID);

		public unsafe delegate Result CreateXcbSurfaceKHR(Instance instance, XcbSurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Bool32 GetPhysicalDeviceXcbPresentationSupportKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, void** connection, void* visual_id);

		public unsafe delegate Result CreateDirectFBSurfaceEXT(Instance instance, DirectFBSurfaceCreateInfoEXT* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Bool32 GetPhysicalDeviceDirectFBPresentationSupportEXT(PhysicalDevice physicalDevice, uint queueFamilyIndex, void** dfb);

		public unsafe delegate Result CreateImagePipeSurfaceFUCHSIA(Instance instance, ImagePipeSurfaceCreateInfoFUCHSIA* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateStreamDescriptorSurfaceGGP(Instance instance, StreamDescriptorSurfaceCreateInfoGGP* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateDebugReportCallbackEXT(Instance instance, DebugReportCallbackCreateInfoEXT* createInfo, AllocationCallbacks* allocator, DebugReportCallbackEXT* callback);
		...
		public unsafe delegate void DebugReportMessageEXT(Instance instance, DebugReportFlagsEXT flags, DebugReportObjectTypeEXT objectType, ulong @object, nuint location, int messageCode, byte* layerPrefix, byte* message);
		...
		public unsafe delegate Result GetPhysicalDeviceExternalImageFormatPropertiesNV(PhysicalDevice physicalDevice, Format format, ImageType type, ImageTiling tiling, ImageUsageFlags usage, ImageCreateFlags flags, ExternalMemoryHandleTypeFlagsNV externalHandleType, ExternalImageFormatPropertiesNV* externalImageFormatProperties);

		public unsafe delegate Result GetMemoryWin32HandleNV(Device device, DeviceMemory memory, ExternalMemoryHandleTypeFlagsNV handleType, void** handle);

		public unsafe delegate void CmdExecuteGeneratedCommandsNV(CommandBuffer commandBuffer, Bool32 isPreprocessed, GeneratedCommandsInfoNV* generatedCommandsInfo);
		...
		public unsafe delegate void CmdBindPipelineShaderGroupNV(CommandBuffer commandBuffer, PipelineBindPoint pipelineBindPoint, Pipeline pipeline, uint groupIndex);

		public unsafe delegate void GetGeneratedCommandsMemoryRequirementsNV(Device device, GeneratedCommandsMemoryRequirementsInfoNV* info, MemoryRequirements2* memoryRequirements);

		public unsafe delegate Result CreateIndirectCommandsLayoutNV(Device device, IndirectCommandsLayoutCreateInfoNV* createInfo, AllocationCallbacks* allocator, IndirectCommandsLayoutNV* indirectCommandsLayout);

		public unsafe delegate void DestroyIndirectCommandsLayoutNV(Device device, IndirectCommandsLayoutNV indirectCommandsLayout, AllocationCallbacks* allocator);
		...
		public unsafe delegate Result GetPhysicalDeviceImageFormatProperties2(PhysicalDevice physicalDevice, PhysicalDeviceImageFormatInfo2* imageFormatInfo, ImageFormatProperties2* imageFormatProperties);

		public unsafe delegate void GetPhysicalDeviceQueueFamilyProperties2(PhysicalDevice physicalDevice, uint* queueFamilyPropertyCount, QueueFamilyProperties2* queueFamilyProperties);

		public unsafe delegate void GetPhysicalDeviceMemoryProperties2(PhysicalDevice physicalDevice, PhysicalDeviceMemoryProperties2* memoryProperties);

		public unsafe delegate void GetPhysicalDeviceSparseImageFormatProperties2(PhysicalDevice physicalDevice, PhysicalDeviceSparseImageFormatInfo2* formatInfo, uint* propertyCount, SparseImageFormatProperties2* properties);

		public unsafe delegate void CmdPushDescriptorSetKHR(CommandBuffer commandBuffer, PipelineBindPoint pipelineBindPoint, PipelineLayout layout, uint set, uint descriptorWriteCount, WriteDescriptorSet* descriptorWrites);

		public unsafe delegate void TrimCommandPool(Device device, CommandPool commandPool, CommandPoolTrimFlags flags);

		public unsafe delegate void GetPhysicalDeviceExternalBufferProperties(PhysicalDevice physicalDevice, PhysicalDeviceExternalBufferInfo* externalBufferInfo, ExternalBufferProperties* externalBufferProperties);
		...
		public unsafe delegate Result GetMemoryWin32HandlePropertiesKHR(Device device, ExternalMemoryHandleTypeFlags handleType, void* handle, MemoryWin32HandlePropertiesKHR* memoryWin32HandleProperties);

		public unsafe delegate Result GetMemoryFdKHR(Device device, MemoryGetFdInfoKHR* getFdInfo, short* fd);

		public unsafe delegate Result GetMemoryFdPropertiesKHR(Device device, ExternalMemoryHandleTypeFlags handleType, short fd, MemoryFdPropertiesKHR* memoryFdProperties);

		public unsafe delegate void GetPhysicalDeviceExternalSemaphoreProperties(PhysicalDevice physicalDevice, PhysicalDeviceExternalSemaphoreInfo* externalSemaphoreInfo, ExternalSemaphoreProperties* externalSemaphoreProperties);
		...
		public unsafe delegate void GetPhysicalDeviceExternalFenceProperties(PhysicalDevice physicalDevice, PhysicalDeviceExternalFenceInfo* externalFenceInfo, ExternalFenceProperties* externalFenceProperties);
		...
		public unsafe delegate Result RegisterDeviceEventEXT(Device device, DeviceEventInfoEXT* deviceEventInfo, AllocationCallbacks* allocator, Fence* fence);

		public unsafe delegate Result RegisterDisplayEventEXT(Device device, DisplayKHR display, DisplayEventInfoEXT* displayEventInfo, AllocationCallbacks* allocator, Fence* fence);

		public unsafe delegate Result GetSwapchainCounterEXT(Device device, SwapchainKHR swapchain, SurfaceCounterFlagsEXT counter, ulong* counterValue);

		public unsafe delegate Result GetPhysicalDeviceSurfaceCapabilities2EXT(PhysicalDevice physicalDevice, SurfaceKHR surface, SurfaceCapabilities2EXT* surfaceCapabilities);

		public unsafe delegate Result EnumeratePhysicalDeviceGroups(Instance instance, uint* physicalDeviceGroupCount, PhysicalDeviceGroupProperties* physicalDeviceGroupProperties);

		public unsafe delegate void GetDeviceGroupPeerMemoryFeatures(Device device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, PeerMemoryFeatureFlags* peerMemoryFeatures);
		...
		public unsafe delegate Result GetDeviceGroupPresentCapabilitiesKHR(Device device, DeviceGroupPresentCapabilitiesKHR* deviceGroupPresentCapabilities);
		...
		public unsafe delegate Result GetPhysicalDevicePresentRectanglesKHR(PhysicalDevice physicalDevice, SurfaceKHR surface, uint* rectCount, Rect2D* rects);

		public unsafe delegate Result CreateDescriptorUpdateTemplate(Device device, DescriptorUpdateTemplateCreateInfo* createInfo, AllocationCallbacks* allocator, DescriptorUpdateTemplate* descriptorUpdateTemplate);

		public unsafe delegate void DestroyDescriptorUpdateTemplate(Device device, DescriptorUpdateTemplate descriptorUpdateTemplate, AllocationCallbacks* allocator);
		...
		public unsafe delegate void CmdPushDescriptorSetWithTemplateKHR(CommandBuffer commandBuffer, DescriptorUpdateTemplate descriptorUpdateTemplate, PipelineLayout layout, uint set, void* data);
		...
		public unsafe delegate Result GetRefreshCycleDurationGOOGLE(Device device, SwapchainKHR swapchain, RefreshCycleDurationGOOGLE* displayTimingProperties);

		public unsafe delegate Result GetPastPresentationTimingGOOGLE(Device device, SwapchainKHR swapchain, uint* presentationTimingCount, PastPresentationTimingGOOGLE* presentationTimings);

		public unsafe delegate Result CreateIOSSurfaceMVK(Instance instance, IOSSurfaceCreateInfoMVK* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateMacOSSurfaceMVK(Instance instance, MacOSSurfaceCreateInfoMVK* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result CreateMetalSurfaceEXT(Instance instance, MetalSurfaceCreateInfoEXT* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate void CmdSetViewportWScalingNV(CommandBuffer commandBuffer, uint firstViewport, uint viewportCount, ViewportWScalingNV* viewportWScalings);

		public unsafe delegate void CmdSetDiscardRectangleEXT(CommandBuffer commandBuffer, uint firstDiscardRectangle, uint discardRectangleCount, Rect2D* discardRectangles);
		...
		public unsafe delegate void GetPhysicalDeviceMultisamplePropertiesEXT(PhysicalDevice physicalDevice, SampleCountFlags samples, MultisamplePropertiesEXT* multisampleProperties);

		public unsafe delegate Result GetPhysicalDeviceSurfaceCapabilities2KHR(PhysicalDevice physicalDevice, PhysicalDeviceSurfaceInfo2KHR* surfaceInfo, SurfaceCapabilities2KHR* surfaceCapabilities);

		public unsafe delegate Result GetPhysicalDeviceSurfaceFormats2KHR(PhysicalDevice physicalDevice, PhysicalDeviceSurfaceInfo2KHR* surfaceInfo, uint* surfaceFormatCount, SurfaceFormat2KHR* surfaceFormats);

		public unsafe delegate Result GetPhysicalDeviceDisplayProperties2KHR(PhysicalDevice physicalDevice, uint* propertyCount, DisplayProperties2KHR* properties);

		public unsafe delegate Result GetPhysicalDeviceDisplayPlaneProperties2KHR(PhysicalDevice physicalDevice, uint* propertyCount, DisplayPlaneProperties2KHR* properties);

		public unsafe delegate Result GetDisplayModeProperties2KHR(PhysicalDevice physicalDevice, DisplayKHR display, uint* propertyCount, DisplayModeProperties2KHR* properties);

		public unsafe delegate Result GetDisplayPlaneCapabilities2KHR(PhysicalDevice physicalDevice, DisplayPlaneInfo2KHR* displayPlaneInfo, DisplayPlaneCapabilities2KHR* capabilities);

		public unsafe delegate void GetBufferMemoryRequirements2(Device device, BufferMemoryRequirementsInfo2* info, MemoryRequirements2* memoryRequirements);

		public unsafe delegate void GetImageMemoryRequirements2(Device device, ImageMemoryRequirementsInfo2* info, MemoryRequirements2* memoryRequirements);

		public unsafe delegate void GetImageSparseMemoryRequirements2(Device device, ImageSparseMemoryRequirementsInfo2* info, uint* sparseMemoryRequirementCount, SparseImageMemoryRequirements2* sparseMemoryRequirements);

		public unsafe delegate Result CreateSamplerYcbcrConversion(Device device, SamplerYcbcrConversionCreateInfo* createInfo, AllocationCallbacks* allocator, SamplerYcbcrConversion* ycbcrConversion);

		public unsafe delegate void DestroySamplerYcbcrConversion(Device device, SamplerYcbcrConversion ycbcrConversion, AllocationCallbacks* allocator);

		public unsafe delegate void GetDeviceQueue2(Device device, DeviceQueueInfo2* queueInfo, Queue* queue);

		public unsafe delegate Result CreateValidationCacheEXT(Device device, ValidationCacheCreateInfoEXT* createInfo, AllocationCallbacks* allocator, ValidationCacheEXT* validationCache);
		...
		public unsafe delegate Result MergeValidationCachesEXT(Device device, ValidationCacheEXT dstCache, uint srcCacheCount, ValidationCacheEXT* srcCaches);

		public unsafe delegate void GetDescriptorSetLayoutSupport(Device device, DescriptorSetLayoutCreateInfo* createInfo, DescriptorSetLayoutSupport* support);
		...
		public unsafe delegate Result GetSwapchainGrallocUsage2ANDROID(Device device, Format format, ImageUsageFlags imageUsage, SwapchainImageUsageFlagsANDROID swapchainImageUsage, ulong* grallocConsumerUsage, ulong* grallocProducerUsage);
		...
		public unsafe delegate Result QueueSignalReleaseImageANDROID(Queue queue, uint waitSemaphoreCount, Semaphore* waitSemaphores, Image image, short* nativeFenceFd);

		public unsafe delegate Result GetShaderInfoAMD(Device device, Pipeline pipeline, ShaderStageFlags shaderStage, ShaderInfoTypeAMD infoType, nuint* infoSize, void* info);

		public unsafe delegate void SetLocalDimmingAMD(Device device, SwapchainKHR swapChain, Bool32 localDimmingEnable);

		public unsafe delegate Result GetPhysicalDeviceCalibrateableTimeDomainsEXT(PhysicalDevice physicalDevice, uint* timeDomainCount, TimeDomainEXT* timeDomains);

		public unsafe delegate Result GetCalibratedTimestampsEXT(Device device, uint timestampCount, CalibratedTimestampInfoEXT* timestampInfos, ulong* timestamps, ulong* maxDeviation);
		...
		public unsafe delegate Result CreateDebugUtilsMessengerEXT(Instance instance, DebugUtilsMessengerCreateInfoEXT* createInfo, AllocationCallbacks* allocator, DebugUtilsMessengerEXT* messenger);

		public unsafe delegate void DestroyDebugUtilsMessengerEXT(Instance instance, DebugUtilsMessengerEXT messenger, AllocationCallbacks* allocator);

		public unsafe delegate void SubmitDebugUtilsMessageEXT(Instance instance, DebugUtilsMessageSeverityFlagsEXT messageSeverity, DebugUtilsMessageTypeFlagsEXT messageTypes, DebugUtilsMessengerCallbackDataEXT* callbackData);

		public unsafe delegate Result GetMemoryHostPointerPropertiesEXT(Device device, ExternalMemoryHandleTypeFlags handleType, void* hostPointer, MemoryHostPointerPropertiesEXT* memoryHostPointerProperties);

		public unsafe delegate void CmdWriteBufferMarkerAMD(CommandBuffer commandBuffer, PipelineStageFlags pipelineStage, Buffer dstBuffer, DeviceSize dstOffset, uint marker);

		public unsafe delegate Result CreateRenderPass2(Device device, RenderPassCreateInfo2* createInfo, AllocationCallbacks* allocator, RenderPass* renderPass);

		public unsafe delegate void CmdBeginRenderPass2(CommandBuffer commandBuffer, RenderPassBeginInfo* renderPassBegin, SubpassBeginInfo* subpassBeginInfo);
		...
		public unsafe delegate Result GetAndroidHardwareBufferPropertiesANDROID(Device device, void** buffer, AndroidHardwareBufferPropertiesANDROID* properties);

		public unsafe delegate Result GetMemoryAndroidHardwareBufferANDROID(Device device, MemoryGetAndroidHardwareBufferInfoANDROID* info, void*** buffer);
		...
		public unsafe delegate void CmdBindTransformFeedbackBuffersEXT(CommandBuffer commandBuffer, uint firstBinding, uint bindingCount, Buffer* buffers, DeviceSize* offsets, DeviceSize* sizes);

		public unsafe delegate void CmdBeginTransformFeedbackEXT(CommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, Buffer* counterBuffers, DeviceSize* counterBufferOffsets);

		public unsafe delegate void CmdEndTransformFeedbackEXT(CommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, Buffer* counterBuffers, DeviceSize* counterBufferOffsets);

		public unsafe delegate void CmdBeginQueryIndexedEXT(CommandBuffer commandBuffer, QueryPool queryPool, uint query, QueryControlFlags flags, uint index);

		public unsafe delegate void CmdEndQueryIndexedEXT(CommandBuffer commandBuffer, QueryPool queryPool, uint query, uint index);

		public unsafe delegate void CmdDrawIndirectByteCountEXT(CommandBuffer commandBuffer, uint instanceCount, uint firstInstance, Buffer counterBuffer, DeviceSize counterBufferOffset, uint counterOffset, uint vertexStride);

		public unsafe delegate void CmdSetExclusiveScissorNV(CommandBuffer commandBuffer, uint firstExclusiveScissor, uint exclusiveScissorCount, Rect2D* exclusiveScissors);
		...
		public unsafe delegate void CmdSetViewportShadingRatePaletteNV(CommandBuffer commandBuffer, uint firstViewport, uint viewportCount, ShadingRatePaletteNV* shadingRatePalettes);

		public unsafe delegate void CmdSetCoarseSampleOrderNV(CommandBuffer commandBuffer, CoarseSampleOrderTypeNV sampleOrderType, uint customSampleOrderCount, CoarseSampleOrderCustomNV* customSampleOrders);

		public unsafe delegate void CmdDrawMeshTasksNV(CommandBuffer commandBuffer, uint taskCount, uint firstTask);

		public unsafe delegate void CmdDrawMeshTasksIndirectNV(CommandBuffer commandBuffer, Buffer buffer, DeviceSize offset, uint drawCount, uint stride);

		public unsafe delegate void CmdDrawMeshTasksIndirectCountNV(CommandBuffer commandBuffer, Buffer buffer, DeviceSize offset, Buffer countBuffer, DeviceSize countBufferOffset, uint maxDrawCount, uint stride);

		public unsafe delegate Result CompileDeferredNV(Device device, Pipeline pipeline, uint shader);

		public unsafe delegate Result CreateAccelerationStructureNV(Device device, AccelerationStructureCreateInfoNV* createInfo, AllocationCallbacks* allocator, AccelerationStructureNV* accelerationStructure);

		public unsafe delegate void DestroyAccelerationStructureKHR(Device device, AccelerationStructureKHR accelerationStructure, AllocationCallbacks* allocator);

		public unsafe delegate void GetAccelerationStructureMemoryRequirementsKHR(Device device, AccelerationStructureMemoryRequirementsInfoKHR* info, MemoryRequirements2* memoryRequirements);

		public unsafe delegate void GetAccelerationStructureMemoryRequirementsNV(Device device, AccelerationStructureMemoryRequirementsInfoNV* info, MemoryRequirements2KHR* memoryRequirements);

		public unsafe delegate Result BindAccelerationStructureMemoryKHR(Device device, uint bindInfoCount, BindAccelerationStructureMemoryInfoKHR* bindInfos);

		public unsafe delegate void CmdCopyAccelerationStructureNV(CommandBuffer commandBuffer, AccelerationStructureKHR dst, AccelerationStructureKHR src, CopyAccelerationStructureModeKHR mode);
		...
		public unsafe delegate void CmdCopyAccelerationStructureToMemoryKHR(CommandBuffer commandBuffer, CopyAccelerationStructureToMemoryInfoKHR* info);
		...
		public unsafe delegate void CmdCopyMemoryToAccelerationStructureKHR(CommandBuffer commandBuffer, CopyMemoryToAccelerationStructureInfoKHR* info);
		...
		public unsafe delegate void CmdWriteAccelerationStructuresPropertiesKHR(CommandBuffer commandBuffer, uint accelerationStructureCount, AccelerationStructureKHR* accelerationStructures, QueryType queryType, QueryPool queryPool, uint firstQuery);

		public unsafe delegate void CmdBuildAccelerationStructureNV(CommandBuffer commandBuffer, AccelerationStructureInfoNV* info, Buffer instanceData, DeviceSize instanceOffset, Bool32 update, AccelerationStructureKHR dst, AccelerationStructureKHR src, Buffer scratch, DeviceSize scratchOffset);

		public unsafe delegate Result WriteAccelerationStructuresPropertiesKHR(Device device, uint accelerationStructureCount, AccelerationStructureKHR* accelerationStructures, QueryType queryType, nuint dataSize, void* data, nuint stride);

		public unsafe delegate void CmdTraceRaysKHR(CommandBuffer commandBuffer, StridedBufferRegionKHR* raygenShaderBindingTable, StridedBufferRegionKHR* missShaderBindingTable, StridedBufferRegionKHR* hitShaderBindingTable, StridedBufferRegionKHR* callableShaderBindingTable, uint width, uint height, uint depth);

		public unsafe delegate void CmdTraceRaysNV(CommandBuffer commandBuffer, Buffer raygenShaderBindingTableBuffer, DeviceSize raygenShaderBindingOffset, Buffer missShaderBindingTableBuffer, DeviceSize missShaderBindingOffset, DeviceSize missShaderBindingStride, Buffer hitShaderBindingTableBuffer, DeviceSize hitShaderBindingOffset, DeviceSize hitShaderBindingStride, Buffer callableShaderBindingTableBuffer, DeviceSize callableShaderBindingOffset, DeviceSize callableShaderBindingStride, uint width, uint height, uint depth);

		public unsafe delegate Result GetRayTracingShaderGroupHandlesKHR(Device device, Pipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* data);

		public unsafe delegate Result GetRayTracingCaptureReplayShaderGroupHandlesKHR(Device device, Pipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* data);

		public unsafe delegate Result GetAccelerationStructureHandleNV(Device device, AccelerationStructureKHR accelerationStructure, nuint dataSize, void* data);

		public unsafe delegate Result CreateRayTracingPipelinesNV(Device device, PipelineCache pipelineCache, uint createInfoCount, RayTracingPipelineCreateInfoNV* createInfos, AllocationCallbacks* allocator, Pipeline* pipelines);

		public unsafe delegate Result CreateRayTracingPipelinesKHR(Device device, PipelineCache pipelineCache, uint createInfoCount, RayTracingPipelineCreateInfoKHR* createInfos, AllocationCallbacks* allocator, Pipeline* pipelines);

		public unsafe delegate Result GetPhysicalDeviceCooperativeMatrixPropertiesNV(PhysicalDevice physicalDevice, uint* propertyCount, CooperativeMatrixPropertiesNV* properties);

		public unsafe delegate void CmdTraceRaysIndirectKHR(CommandBuffer commandBuffer, StridedBufferRegionKHR* raygenShaderBindingTable, StridedBufferRegionKHR* missShaderBindingTable, StridedBufferRegionKHR* hitShaderBindingTable, StridedBufferRegionKHR* callableShaderBindingTable, Buffer buffer, DeviceSize offset);
		...
		public unsafe delegate Result GetPhysicalDeviceSurfacePresentModes2EXT(PhysicalDevice physicalDevice, PhysicalDeviceSurfaceInfo2KHR* surfaceInfo, uint* presentModeCount, PresentModeKHR* presentModes);

		public unsafe delegate Result GetDeviceGroupSurfacePresentModes2EXT(Device device, PhysicalDeviceSurfaceInfo2KHR* surfaceInfo, DeviceGroupPresentModeFlagsKHR* modes);
		...
		public unsafe delegate Result EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(PhysicalDevice physicalDevice, uint queueFamilyIndex, uint* counterCount, PerformanceCounterKHR* counters, PerformanceCounterDescriptionKHR* counterDescriptions);

		public unsafe delegate void GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(PhysicalDevice physicalDevice, QueryPoolPerformanceCreateInfoKHR* performanceQueryCreateInfo, uint* numPasses);
		...
		public unsafe delegate Result GetImageDrmFormatModifierPropertiesEXT(Device device, Image image, ImageDrmFormatModifierPropertiesEXT* properties);
		...
		public unsafe delegate Result CreateHeadlessSurfaceEXT(Instance instance, HeadlessSurfaceCreateInfoEXT* createInfo, AllocationCallbacks* allocator, SurfaceKHR* surface);

		public unsafe delegate Result GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(PhysicalDevice physicalDevice, uint* combinationCount, FramebufferMixedSamplesCombinationNV* combinations);
		...
		public unsafe delegate Result AcquirePerformanceConfigurationINTEL(Device device, PerformanceConfigurationAcquireInfoINTEL* acquireInfo, PerformanceConfigurationINTEL* configuration);
		...
		public unsafe delegate Result GetPerformanceParameterINTEL(Device device, PerformanceParameterTypeINTEL parameter, PerformanceValueINTEL* value);

		public unsafe delegate ulong GetDeviceMemoryOpaqueCaptureAddress(Device device, DeviceMemoryOpaqueCaptureAddressInfo* info);

		public unsafe delegate Result GetPipelineExecutablePropertiesKHR(Device device, PipelineInfoKHR* pipelineInfo, uint* executableCount, PipelineExecutablePropertiesKHR* properties);

		public unsafe delegate Result GetPipelineExecutableStatisticsKHR(Device device, PipelineExecutableInfoKHR* executableInfo, uint* statisticCount, PipelineExecutableStatisticKHR* statistics);

		public unsafe delegate Result GetPipelineExecutableInternalRepresentationsKHR(Device device, PipelineExecutableInfoKHR* executableInfo, uint* internalRepresentationCount, PipelineExecutableInternalRepresentationKHR* internalRepresentations);
		...
		public unsafe delegate Result GetPhysicalDeviceToolPropertiesEXT(PhysicalDevice physicalDevice, uint* toolCount, PhysicalDeviceToolPropertiesEXT* toolProperties);

		public unsafe delegate Result CreateAccelerationStructureKHR(Device device, AccelerationStructureCreateInfoKHR* createInfo, AllocationCallbacks* allocator, AccelerationStructureKHR* accelerationStructure);

		public unsafe delegate void CmdBuildAccelerationStructureKHR(CommandBuffer commandBuffer, uint infoCount, AccelerationStructureBuildGeometryInfoKHR* infos, AccelerationStructureBuildOffsetInfoKHR** offsetInfos);

		public unsafe delegate void CmdBuildAccelerationStructureIndirectKHR(CommandBuffer commandBuffer, AccelerationStructureBuildGeometryInfoKHR* info, Buffer indirectBuffer, DeviceSize indirectOffset, uint indirectStride);

		public unsafe delegate Result BuildAccelerationStructureKHR(Device device, uint infoCount, AccelerationStructureBuildGeometryInfoKHR* infos, AccelerationStructureBuildOffsetInfoKHR** offsetInfos);
		...
		public unsafe delegate Result CreateDeferredOperationKHR(Device device, AllocationCallbacks* allocator, DeferredOperationKHR* deferredOperation);
		...
		public unsafe delegate void CmdBindVertexBuffers2EXT(CommandBuffer commandBuffer, uint firstBinding, uint bindingCount, Buffer* buffers, DeviceSize* offsets, DeviceSize* sizes, DeviceSize* strides);
		...
		public unsafe delegate void CmdSetStencilOpEXT(CommandBuffer commandBuffer, StencilFaceFlags faceMask, StencilOp failOp, StencilOp passOp, StencilOp depthFailOp, CompareOp compareOp);

		public unsafe delegate Result CreatePrivateDataSlotEXT(Device device, PrivateDataSlotCreateInfoEXT* createInfo, AllocationCallbacks* allocator, PrivateDataSlotEXT* privateDataSlot);
		...
		public unsafe delegate Result SetPrivateDataEXT(Device device, ObjectType objectType, ulong objectHandle, PrivateDataSlotEXT privateDataSlot, ulong data);

		public unsafe delegate void GetPrivateDataEXT(Device device, ObjectType objectType, ulong objectHandle, PrivateDataSlotEXT privateDataSlot, ulong* data);
	}
}
